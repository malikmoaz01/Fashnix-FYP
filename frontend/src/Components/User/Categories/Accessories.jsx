...
const Accessories = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Filter for Accessories products only
  ...
  const priceBrackets = [
    ...
    { label: 'Under Rs500', value: [0, 500] },
    { label: 'Rs500 - Rs1,000', value: [500, 1000] },
  ...
  useEffect(() => {
    ...
    // Apply subsubcategory filter (Covers, Chargers, etc.)
    // Only apply if both subcategory and subsubcategory are selected
  ...
  }, [searchQuery, subcategory, subsubcategory, priceRange, sortOption, products]);
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-4 md:p-6">
      <h1 className="text-3xl font-bold text-center mb-6 text-pink-600">Accessories Collection</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredProducts.length === 0 ? (
            <div className="col-span-full flex flex-col items-center justify-center py-12">
              ...
              <p className="text-center text-gray-500">No accessories products match your search criteria</p>
              <button 
                onClick={resetFilters}
