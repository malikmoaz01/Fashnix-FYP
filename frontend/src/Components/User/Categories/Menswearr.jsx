...
const MenSwear = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const mensProducts = data.filter(product => 
  ...
  useEffect(() => {
    ...
    // Apply subsubcategory filter (for T-shirts, Jeans, etc.)
    if (subsubcategory) {
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-4 md:p-6">
      <h1 className="text-3xl font-bold text-center mb-6 text-pink-600">Men's Clothing Collection</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredProducts.length === 0 ? (
            <div className="col-span-full flex flex-col items-center justify-center py-12">
              ...
              <p className="text-center text-gray-500">No men's clothing products match your search criteria</p>
              <button 
                onClick={resetFilters}
              ...
              return (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-sm text-pink-500 mt-1">{product.subsubcategory || 'Men\'s Clothing'}</p>
