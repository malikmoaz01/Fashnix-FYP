...
//             await saveOrderToDatabase(formattedOrder);
            
//             // Send confirmation email after order is set and saved
//             if (customerEmail) {
//               sendConfirmationEmail(orderId, customerEmail);
//             }
//           } else {
...
//     // Get valid status values from your schema (adjust these based on your actual model)
...
//     return {
//       ...localOrder,
//       status: status, // Use the validated status value
...
//           <p className="text-red-600 mt-1">{error || "No order info available."}</p>
//         </div>
//         <button
