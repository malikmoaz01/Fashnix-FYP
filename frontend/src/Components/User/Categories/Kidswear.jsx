...
const KidsClothing = () => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const kidsProducts = data.filter(product => 
          ...
          product.subcategory === "Kid's Clothing"
        );
  ...
  const priceBrackets = [
    ...
    { label: 'Rs1,000 - Rs2,000', value: [1000, 2000] },
    { label: 'Over Rs2,000', value: [2000, 100000] }
  ];
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-4 md:p-6">
      <h1 className="text-3xl font-bold text-center mb-6 text-pink-600">Kids' Clothing Collection</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredProducts.length === 0 ? (
            <div className="col-span-full flex flex-col items-center justify-center py-12">
              ...
              <p className="text-center text-gray-500">No kids' clothing products match your search criteria</p>
              <button 
                onClick={resetFilters}
              ...
              return (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-sm text-pink-500 mt-1">{product.subsubcategory || 'Kids\' Clothing'}</p>
