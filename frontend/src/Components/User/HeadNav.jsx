...
const [wishlistBlink, setWishlistBlink] = useState(false);
  ...
  return (
    <div className="sticky top-0 z-30 w-full bg-white shadow-md">
      {/* Upper Header with Logo, Brand and Icons */}
      <header className="mx-auto w-full flex h-16 max-w-[1200px] items-center justify-between px-5 bg-white md:px-10 border-b border-gray-200">
        {/* Logo */}
